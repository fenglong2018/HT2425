...
//	            LED_2_High;
        ...
        if( (Sleep_delay >= TA0_400ms)  && (DC_OUT) && (KEY_UP) && (RS485_IDLE) )
        {
...
//                    	LED_2_High;
			...
			if( DC_OUT && KEY_UP && ALERT_DIS && RS485_IDLE )
			{
				...
				if( DC_OUT && KEY_UP && ALERT_DIS && RS485_IDLE && (Sleep_delay >= TA0_400ms))
				{
...
void SleepCheck(void)
{
    ...
    if((SleepCount > TA0_20m) && (SystemMode != SystemSleepMode ))
    {
...
void ShipMode(void)
{
	...
	if((HW_PT_Status.Bits.HW_UV ==1)||(SystemMode == SystemShipMode) || (FW_PT_Status.Bits.PT_UV == 1))
	{
	    ...
	    if(SysSHIPCount>200)		//fenglong 20190625
	    {
...
//    if(SystemMode==SystemSleepMode)
//    {
//    	if( (DC_IN) || (ALERT_ON) || (KEY_DOWN) || (RS485_BUSY) )
//    	{
//    		Sleep_delay=0;
//    	}
//    	else
...
//    	}
//
//    	if( (Sleep_delay >= TA0_400ms)  && (DC_OUT) && (KEY_UP) && (RS485_IDLE) && (ALERT_DIS) )
//        {
//        	if( I2C_Load_BQ76930(&(BQ76930Data.SysStatus.StatusByte), SYS_STAT, 1) == 0 )
//        	{
//        		if(BQ76930Data.SysStatus.StatusBit.DEVICE_XREADY == 1)
...
//	    	for(i=0;i<30;i++)
//	    	{
//				if(BQ76930Data.SysCtrl2.SysCtrl2Bit.CC_EN)
//				{
//					temp=0;
//					if( I2C_Master_TransmitByte(BQ76930_SYS_CTRL2_Addr, temp) == 0)
//					{
...
//	//		    	LED_1_High;
//					Sleep_delay=0;
//					WDTCTL = WDT_ADLY_1000;     // 设置看门狗定时周期32k晶振对应为1s
//				}
//				else
//				{
//					break;
...
//					      FW_PT_Status.Bits.PT_OCP =0;
//					      FW_PT_Status.Bits.PT_ODP =0;
//						  if (((HW_PT_Status.Bits.HW_OCD == 1) || (HW_PT_Status.Bits.HW_SCD == 1)))
//						  {
//							  Buff_1 = HW_PT_Status.Byte;
//							  BQ76930Data.SysStatus.StatusByte =0;
//							  //HW_PT_Status.Byte = 0x00;
 ...
 *
 * NORMAL    5.67mA
 * SLEEPPING 1.68mA  ,4.09mA,, 5.06
 * SHIPPING	 10.3uA
 * CHARGING  5.88~6.23mA
 **/
...
//
//                SysRunCount = 0 ;
//               _bis_SR_register_on_exit(LPM0_bits);// 退出低功耗模式
//                _BIS_SR(LPM0_bits + GIE);         //加上去無法開機
////            }
//        }


////20190626 fenglong 备份
//void SleepMode(void)
//{
//
//    uchar temp,temp1,i;
...
//
////        Sleep_delay++;
//        if(Sleep_delay >=TA0_2s)//可增加---10S暂定
//        {
////            Sleep_delay =0;
////            power_first_flag=0;
//
//            //休眠前配置
//            //关充放电
////            temp = BQ76930Data.SysCtrl2.SysCtrl2Byte & 0xBC ;       //DISABLE CC_EN, DSG_ON ,CHG_ON
//            temp=0;
//        	if( I2C_Master_TransmitByte(BQ76930_SYS_CTRL2_Addr, temp) == 0)
//            {
//                BQ76930Data.SysCtrl2.SysCtrl2Byte &= temp ;
//            }
//            //BQ唤醒的清除配置   1.除能CC_EN 2.确认没有X_READY和ALERT,CC_READY标志 .确认时间500ms  再进入休眠
//
//            if (BQ76930Data.SysStatus.StatusBit.DEVICE_XREADY == 1)
//            {
//            	temp1 = BQ76930Data.SysStatus.StatusByte;
...
//        	if(BQ76930Data.SysStatus.StatusBit.CC_READY == 1)
//        	{
//        		temp = I2C_Load_BQ76930(&(BQ76930Data.CC.CCByte.CC_HI), CC_HI_BYTE, 2);
//        		if(temp ==0)
//        		{
//        			temp16 = BQ76930Data.CC.CCByte.CC_HI;
//        			temp16 <<=8;
//        			temp16&=0xff00;
//        			temp16 |= BQ76930Data.CC.CCByte.CC_LO;
//                    if(temp16 >0x8000)
//                    {
//                    	temp16 = 0-temp16;
//                        BatteryData.CC.CCWord = (long)temp16*844/250;
...
////        		LED_1_High;
//        	}
//        	else if(BQ76930Data.SysStatus.StatusBit.OVRD_ALERT == 1)
//        	{
//        		Sleep_delay = TA0_1s;
////        		LED_2_High;
//        	}
//        	else if(BQ76930Data.SysStatus.StatusBit.CC_READY == 1)
//        	{
//        		Sleep_delay = TA0_1s;
//        		LED_3_High;
//        	}
...
////            if( (BQ76930Data.SysStatus.StatusBit.DEVICE_XREADY == 1)
////            	|| (BQ76930Data.SysStatus.StatusBit.OVRD_ALERT == 1)
////				|| (BQ76930Data.SysStatus.StatusBit.CC_READY == 1)
////            	)
////            {
////            	Sleep_delay = TA0_1s;
//////            	LED_1_High;
...
//
//                //低功耗引脚配置
//                P1DIR &= ~BIT3;     // key     //0输入，1输出
//                P1DIR &= ~BIT4;     //DC
//                P1DIR &= ~BIT5;     //BQ
//                P2DIR &= ~BIT3;     //485
//
//                P1IES &= ~BIT3;     // key    	//0  低电平到高电平
//                P1IES &= ~BIT4;
////                P1IES |= BIT4;     //DC			//1 高电平到低电平
//                P1IES &= ~BIT5;     //BQ		//0  低电平到高电平
//                P2IES |= BIT3;     //485		//1 高电平到低电平
