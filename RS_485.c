...
//    BatteryRealData.Time_t.BMS_week=17;
...
#if 0
    BatteryRealData.BMS_Vbat.val=U16_SWAP(25600);//(BatteryData.VBat.VBatWord);

    BatteryRealData.Vcell_num=CELL_NUM;

    BatteryRealData.Vcell[0].val=U16_SWAP(3512);//(BatteryData.VCell1.VCell1Word);
    BatteryRealData.Vcell[1].val=U16_SWAP(3653);//(BatteryData.VCell2.VCell2Word);
    BatteryRealData.Vcell[2].val=U16_SWAP(3745);//(BatteryData.VCell3.VCell3Word);
    BatteryRealData.Vcell[3].val=U16_SWAP(3856);//(BatteryData.VCell4.VCell4Word);
    BatteryRealData.Vcell[4].val=U16_SWAP(3967);//(BatteryData.VCell5.VCell5Word);
    BatteryRealData.Vcell[5].val=U16_SWAP(3958);//(BatteryData.VCell6.VCell6Word);
    BatteryRealData.Vcell[6].val=U16_SWAP(4125);//(BatteryData.VCell7.VCell7Word);

    BatteryRealData.Curr[0].val=U16_SWAP(1000);//BatteryData.CC.CCByte.CC_LO;
    BatteryRealData.Curr[1].val=U16_SWAP(2000);//BatteryData.CC.CCByte.CC_HI;

    BatteryRealData.TempNum=2;

    BatteryRealData.Temp[1]=113;//BatteryData.TS1.TS1Word;
    BatteryRealData.Temp[0]=122;//BatteryData.TS2.TS2Word;

    BatteryRealData._VSTATE.bit.VOV=1;
    BatteryRealData._VSTATE.bit.VUV=1;
    BatteryRealData._VSTATE.bit.BVOV=0;
    BatteryRealData._VSTATE.bit.BVUV=1;
    BatteryRealData._VSTATE.bit.wVOV=1;
    BatteryRealData._VSTATE.bit.wVUV=1;
    BatteryRealData._VSTATE.bit.wBVOV=1;
    BatteryRealData._VSTATE.bit.wBVUV=0;

    BatteryRealData._VSTATE.bit.VDIFF=0;
    ...
    BatteryRealData._CSTATE.bit.OCCSG=1;
    BatteryRealData._CSTATE.bit.SHORT=0;
    BatteryRealData._CSTATE.bit.OCDSG1=1;
    BatteryRealData._CSTATE.bit.OCDSG2=1;
    BatteryRealData._CSTATE.bit.wOCCSG=0;
    BatteryRealData._CSTATE.bit.wOCDSG=1;
    ...
    BatteryRealData._TSTATE.bit.TCELL_CSGH=0;
    BatteryRealData._TSTATE.bit.TCELL_CSGL=0;
    BatteryRealData._TSTATE.bit.TCELL_DSGH=0;
    BatteryRealData._TSTATE.bit.TCELL_DSGL=1;
    BatteryRealData._TSTATE.bit.TENV_H=0;
    BatteryRealData._TSTATE.bit.TENV_L=0;
    BatteryRealData._TSTATE.bit.TFET_H=0;
    BatteryRealData._TSTATE.bit.TFET_L=1;

    BatteryRealData._TSTATE.bit.wTCELL_H=0;
    BatteryRealData._TSTATE.bit.wTCELL_L=0;
    BatteryRealData._TSTATE.bit.wTENV_H=0;
    BatteryRealData._TSTATE.bit.wTENV_L=1;
    BatteryRealData._TSTATE.bit.wTFET_H=1;
  ...
  //  BatteryRealData.SOC=SW_Status.;
    ...
    BatteryRealData._ALARM.bit.bit0=0;
    ...
    BatteryRealData._FETSTATE.bit.DFET=0;
    BatteryRealData._FETSTATE.bit.CFET=1;
    ...
    BatteryRealData.BlanceState.val=U16_SWAP(0x7788);
    BatteryRealData.DchgNum.val=U16_SWAP(0x9900);

    BatteryRealData.ChgNum.val=U16_SWAP(0x1234);

    BatteryRealData.SOC=0x56;

    BatteryRealData.CapNow.val=U16_SWAP(0x7890);
    BatteryRealData.CapFull.val=U16_SWAP(0x6688);
